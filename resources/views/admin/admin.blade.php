              ...
              <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top ">
                  <a href="#" class="navbar-brand text-white d-block
                   ...
                   <ul class="navbar-nav flex-column mt-2">
                      ...
                      <li class="nav-item"><a href="admin_assistants" class="nav-link text-white p-3 mb-1 sidebar-link">
                      <i class="fa fa-line-chart text-light fa-lg mr-3"></i>Assistants</a></li>
                      <li class="nav-item"><a href="time_tables" class="nav-link text-white p-3 mb-1 sidebar-link">
                      <i class="fa fa-line-chart text-light fa-lg mr-3"></i>Time Tables</a></li>
                      <li class="nav-item"><a href="admin_courses" class="nav-link text-white p-3 mb-1 sidebar-link">
                      <i class="fa fa-book text-light fa-lg mr-3"></i>Courses</a></li>
                   </ul>
              </div>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <h1 class="text-center mt-5 ">Postsffff</h1><hr>
        </div>
