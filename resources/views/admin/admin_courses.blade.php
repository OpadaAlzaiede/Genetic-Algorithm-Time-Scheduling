              ...
              <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top ">
                  <a href="#" class="navbar-brand text-white d-block
                   ...
                   <ul class="navbar-nav flex-column mt-2">
                      ...
                      <li class="nav-item"><a href="admin_courses" class="nav-link text-white p-3 mb-1 sidebar-link current">
                            ...
                            <tbody>
                               ...
                               <?php foreach ($course as $key => $value): ?>
                                ...
                                <tr>
                                    ...
                                    <td><button type="button" class="btn-info btn-sm edit">Edit</button>
                                    <button href="" type="button" class="btn-danger btn-sm delete">Delete</button></td>
                                      <!-- start delete modal -->
