              ...
              <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top  ">
                  <a href="#" class="navbar-brand text-white d-block
                   ...
                   <div class="bottom-border pb-1">
                      <img src="{{ asset($user ->img)}}" width="50" class="rounded-circle mr-1" alt="">
                      <a href="#" class="text-white">{{ $user ->username}}</a>
                   </div>
                   <ul class="navbar-nav flex-column mt-2">
                      <li class="nav-item"><a href="{{url('doctor')}}" class="nav-link text-white p-3 mb-1 ">
                      <i class="fa fa-home text-light fa-lg mr-3"></i>home</a></li>
                      <li class="nav-item"><a href="doctor_profile" class="nav-link text-white p-3 mb-1 sidebar-link">
                      ...
                      <li class="nav-item"><a href="doctor_teacher" class="nav-link text-white p-3 mb-1 sidebar-link">
            ...
            <form action="/addPost/{id}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mt-5">
                    <div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
                        ...
                        <textarea class="form-control input100" id="summary-ckeditor" value="تااااتاتات" name="summary-ckeditor"></textarea>                        <span class="focus-input100"></span>
                    </div>
                </div>
                <div>
